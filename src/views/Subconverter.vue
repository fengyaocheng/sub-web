  ...
  data() {
    return {
      ...
      options: {
        ...
        backendOptions: [{ value: "https://rimutuyuan.space/sub?" }],
        remoteConfig: [
          {
            label: "定制",
            options: [
              {
                label: "didi内网",
                value:
                  "https://gitee.com/fengyaocheng/rule-set/raw/master/template/we.ini"
              },
              {
                label: "xinao内网",
                value:
                  "https://gitee.com/fengyaocheng/rule-set/raw/master/template/we-xinao.ini"
              }
            ]
          },
          {
