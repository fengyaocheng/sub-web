  ...
  data() {
    return {
      ...
      options: {
        ...
        backendOptions: [{ value: "http://rimutuyuan.space/sub?" }],
        remoteConfig: [
          {
            label: "ACL4SSR",
            options: [
              {
                label: "didi内网",
                value:
                  "https://gitee.com/fengyaocheng/rule-set/blob/master/template/we.ini"
              },
              {
                label: "xinao内网",
                value:
                  "https://gitee.com/fengyaocheng/rule-set/blob/master/template/we-xinao.ini"
              },
              {
